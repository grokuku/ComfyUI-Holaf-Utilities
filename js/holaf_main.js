    ...
    const HolafUtilitiesMenu = {
        ...
        init() {
            ...
            menuItems.forEach(itemInfo => {
                ...
                let checkbox = null;
                if (itemInfo.special === "toggle_monitor" || itemInfo.special === "toggle_layout_tools") {
            ...
            mainButton.onclick = (e) => {
                ...
                if (this.dropdownMenuEl.style.display === "block") {
                    ...
                    this.dropdownMenuEl.querySelectorAll('li').forEach(li => {
                        ...
                        if (check) {
                            const isMonitor = li.textContent.includes("Monitor");
                            const isActive = isMonitor ? app.holafSystemMonitor?.isVisible : window.holaf?.layoutTools?.isVisible;
